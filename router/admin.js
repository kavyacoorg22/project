...
router.post('/category', adminAuth.checkSession, upload.single('image'), adminAuth.checkSession,categoryController.createcat)
...
router.post('/product', upload.array('images', 10), validateImg,adminAuth.checkSession, productController.product)
